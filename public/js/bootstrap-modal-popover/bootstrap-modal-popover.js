/* NOTE: Please do not replace this or update this plugin as I have made some customisations for this to work with airshr connect */
...
!function ($) {
    ...
    ModalPopover.prototype = $.extend({}, $.fn.modal.Constructor.prototype, {
        ...
        getPosition:function () {
            ...
            var pos = {left : $element.offset().left, top: $element.offset().top};
            return $.extend({}, (pos), {
        ...
        show: function () {
            ...
            $dialog.css({ top: 0, left: 0, display: 'block', 'z-index': 9999 });
            ...
            switch (placement) {
                case 'bottom':
                    tp = { top: pos.top + pos.height - 70, left: pos.left + pos.width / 2 - actualWidth / 2}
                    break;
                case 'top':
                    tp = { top: pos.top - actualHeight -50, left: pos.left + pos.width / 2 - actualWidth / 2 }
                    break;
                case 'left':
                    tp = { top: pos.top + pos.height / 2 - actualHeight / 2, left: pos.left - actualWidth }
                    break;
                case 'right':
                    tp = { top: pos.top + pos.height / 2 - actualHeight / 2 - 80, left: pos.left + pos.width }
                    break;
            }
