...
class WebsocketClient
{
	...
	public function connect($host, $port, $path, $origin = false)
	{
		...
		$this->_Socket = stream_socket_client($host, $errno, $errstr, ini_get('default_socket_timeout'), STREAM_CLIENT_CONNECT, $socketContext);
			
		socket_set_timeout($this->_Socket, 1, 10000);
