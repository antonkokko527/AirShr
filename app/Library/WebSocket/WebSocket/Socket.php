...
class Socket
{
	...
	{		
		$pem_file = base_path() . \Config::get('app.WebSocketPEMFile');
		$pem_passphrase = '';		
		...
		if(!file_exists($pem_file))
		{
			$dn = array(
				"countryName" => "AU",
				"stateOrProvinceName" => "News South Wale",
				"localityName" => "AirShr",
				"organizationName" => "AirShr",
				"organizationalUnitName" => "AirShr",
				"commonName" => "airshr",
				"emailAddress" => "admin@airshr.com"
			);
