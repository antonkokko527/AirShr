		...
		<form id="content-sub-header-form">
			<div class="form-group">
				<select class="form-control" id="content_content_type_id">
					...
					<option value="{{ $key }}"  <?php if ($key == $content_type_id_for_talkshow) echo "selected"; ?>>{{ $val }}</option>
					@endforeach
				</select>
			</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="event_form">
                        <div class="form-group">
                            <label for="what" class="col-md-4 control-label">Show</label>
                            <div class="col-md-20"><input type="text" name="what" id="what" class="form-control" autocomplete="off" placeholder="Talk Show"></div>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="new_event_form">
                        <div class="form-group">
                            <label for="new_what" class="col-md-4 control-label">Show</label>
                            <div class="col-md-20"><input type="text" name="new_what" id="new_what" class="form-control" autocomplete="off" placeholder="Talk Show"></div>
                        </div>
                        <div class="form-group">
...
<script src="/js/scheduler.js?v={{ \Config::get('app.ConnectWebAppVersion') }}" type="text/javascript"></script>
<!-- Ready Button -->
<script>
